...
TimerQueuePtr EventLoop::getTimerQueue() { return timerQueue; }

void EventLoop::handlerTimerQueue() { timerQueue->handleRead(); }

bool EventLoop::isInLoopThread() const {
  return threadId == std::this_thread::get_id();
}

bool EventLoop::geteventHandling() const { return eventHandling; }

std::thread::id EventLoop::getThreadId() const { return threadId; }
