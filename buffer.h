...
class Buffer {
 public:
  ...
  int32_t readableBytes() const { return writerIndex - readerIndex; }

  int32_t writableBytes() const { return buffer.size() - writerIndex; }

  int32_t getWriterIndex() { return writerIndex; }

  int32_t prependableBytes() const { return readerIndex; }
  ...
  int32_t internalCapacity() const { return buffer.capacity(); }
